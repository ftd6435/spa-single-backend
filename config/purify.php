...
return [
    ...
    */
    ...
    'configs' => [
        ...
        // Liste blanche alignée sur les balises produites par CKEditor 5
        // (formatage, listes, liens, tableaux, images et légendes)
        'default' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,sub,sup,a[href|title|target|rel],ul,ol,li,p[style],br,span[style],img[width|height|alt|src],blockquote,pre,code,hr,figure[class],figcaption,table,thead,tbody,tr,th[colspan|rowspan],td[colspan|rowspan]',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align',
            // Autorise les liens "ouvrir dans un nouvel onglet" de CKEditor
