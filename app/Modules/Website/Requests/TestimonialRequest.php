...
/**
 * FormRequest dédiée à la validation des données d’un témoignage.
 *
 * Cette classe centralise les règles de validation utilisées lors :
 * - de la création d’un témoignage ;
 * - de la modification d’un témoignage existant.
 *
 ...
 *
 * Un témoignage est lié à deux entités métier :
 * - un projet, qui représente la réalisation concernée ;
...
class TestimonialRequest extends FormRequest
{
    ...
    /**
     * Définit les règles de validation applicables aux données d’un témoignage.
     *
     ...
     *
     * Règles principales :
     * - `project_id` : projet obligatoire en création, doit exister dans `projects` ;
     * - `client_id` : client obligatoire en création, doit exister dans `clients` ;
     * - `content` : contenu du témoignage obligatoire en création, chaîne d’au moins 2 caractères.
     *
